...
class WebServices {
  ...
  WebServices._() {
    freeDio.options.connectTimeout = const Duration(seconds: 30);
    freeDio.options.baseUrl = ApiConstants.baseUrl;

    tokenDio.options.connectTimeout = const Duration(seconds: 30);
